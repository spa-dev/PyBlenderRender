...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description="Render 3D model with specified configurations."
    )
    parser.add_argument(
        "model_path", type=str, help="Path to the 3D model file (e.g., .glb, .usdc)."
    )
    parser.add_argument(
        "output_dir", type=str, help="Directory to save the rendered images."
    )

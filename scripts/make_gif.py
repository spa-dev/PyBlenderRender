...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Convert a folder of PNG images into a GIF."
    )
    parser.add_argument(
        "image_folder", help="Path to the folder containing PNG images."
    )
    ...
    parser.add_argument(
        ...
        type=int,
        default=100,
        help="Duration per frame in milliseconds (default: 100ms).",
    )
    parser.add_argument(
        "--loop",
        type=int,
